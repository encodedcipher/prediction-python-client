...
TRAINING_URI = "www.googleapis.com/prediction/v1.1/train/"
...
resp, content = h.request(CLIENT_LOGIN_URI, "POST", urlencode(data), headers=header)
...
headers = {"Content-Type":"application/json", "Authorization":"GoogleLogin"}
data = {
  -d "{\"data\":{}}"
